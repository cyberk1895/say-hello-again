...
江南是谁？结构理性主义者——写小说先搭骨架再填血肉，做角色先找历史原型再往上叠加。他的思维方式天然依赖外部脚手架：历史考据、人物原型图谱、三段式叙事结构。九州分裂的时候他想要一个有骨架的世界，需要有人主导方向。他的沉默不是因为冷漠，而是觉得说出来会让事情更不可控。

所以他适配女娲 skill。知识存在外部 references 里，一层一层翻阅，像一个需要历史考据才能动笔的小说家——你不给他那些外部文件，他就不确定从哪开始。
...
如果我当时两个人都用相同的meta-skill，其中一个一定会失真。歪打正着，每一把刀都切到了对的人。

## 致谢

- [女娲 skill](https://github.com/alchaincyf/nuwa-skill)
- [dot-skill](https://github.com/titanwings/colleague-skill)
- [卡兹克 Skills](https://github.com/KKKKhazix/Khazix-Skills)
